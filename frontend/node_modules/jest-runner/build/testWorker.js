'use strict';
/* build-hook-start *//*00001*/try { require('/Users/katherynrojas/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').default({tool: 'jest', checkSum: '20a8fce98b99a6dec6e5e7Uw9IVksIAgZYAFYBUlECB10BU1FS', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/katherynrojas/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20a8fce98b99a6dec6e5e7Uw9IVksIAgZYAFYBUlECB10BU1FS', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
